...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const yyyt = ['꒰ Bear Café ꒱']; // ชื่อ button1
    const ddds = ['https://discord.gg/bearcafe']; // ลิ้ง button1

   const iooi = ['꒰ CHERRY MILK. ꒱']; // ชื่อ button 2
   const iiio = ['https://discord.gg/cherrymilk']; // ลิ้ง button 2
